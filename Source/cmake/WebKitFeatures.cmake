...
macro(WEBKIT_OPTION_BEGIN)
    ...
    if (WTF_CPU_ARM64 OR WTF_CPU_X86_64)
        ...
        set(USE_CONTINUOUS_ARENA_DEFAULT OFF)
        set(ENABLE_C_LOOP_DEFAULT OFF)
        set(ENABLE_SAMPLING_PROFILER_DEFAULT ON)
        set(ENABLE_JSHEAP_CHERI_OFFSET_REFS_DEFAULT OFF)
        set(ENABLE_JIT_ARM64_EMBED_POINTERS_AS_ALIGNED_LITERALS_DEFAULT ON)
    ...
    WEBKIT_OPTION_DEFINE(ENABLE_YARR_JIT "Toggle YARR JIT" PRIVATE ${ENABLE_JIT_DEFAULT})
    ...
    WEBKIT_OPTION_DEFINE(USE_CONTINUOUS_ARENA "Use ContinuousArenaMalloc allocator instead of FastMalloc for JS heap space" PRIVATE ${USE_CONTINUOUS_ARENA_DEFAULT})
    WEBKIT_OPTION_DEFINE(ENABLE_JSHEAP_CHERI_OFFSET_REFS "Use capability to represent JS heap pointers in JS values" PRIVATE ${ENABLE_JSHEAP_CHERI_OFFSET_REFS_DEFAULT})
    WEBKIT_OPTION_DEFINE(ENABLE_JIT_ARM64_EMBED_POINTERS_AS_ALIGNED_LITERALS "For ARM64, embed pointers as aligned literals into JIT-produced code" PRIVATE ${ENABLE_JIT_ARM64_EMBED_POINTERS_AS_ALIGNED_LITERALS_DEFAULT})
    ...
    WEBKIT_OPTION_DEPEND(USE_CONTINUOUS_ARENA USE_SYSTEM_MALLOC)
    WEBKIT_OPTION_DEPEND(ENABLE_JSHEAP_CHERI_OFFSET_REFS USE_CONTINUOUS_ARENA)
endmacro()
