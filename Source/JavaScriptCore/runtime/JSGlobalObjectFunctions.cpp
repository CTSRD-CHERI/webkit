...
EncodedJSValue JSC_HOST_CALL globalFuncEval(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL globalFuncParseInt(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL globalFuncParseFloat(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL globalFuncDecodeURI(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL globalFuncDecodeURIComponent(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    static Bitmap<256> emptyBitmap;
    return JSValue::encode(decode(globalObject, callFrame->argument(0), emptyBitmap, true));
}

EncodedJSValue JSC_HOST_CALL globalFuncEncodeURI(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL globalFuncEncodeURIComponent(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL globalFuncEscape(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL globalFuncUnescape(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(toStringView(globalObject, callFrame->argument(0), [&] (StringView view) {
...
EncodedJSValue JSC_HOST_CALL globalFuncThrowTypeError(HeapPtr<JSGlobalObject> globalObject, CallFrame*)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL globalFuncThrowTypeErrorArgumentsCalleeAndCaller(HeapPtr<JSGlobalObject> globalObject, CallFrame*)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL globalFuncMakeTypeError(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL globalFuncProtoGetter(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL globalFuncProtoSetter(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL globalFuncHostPromiseRejectionTracker(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL globalFuncBuiltinLog(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    dataLog(callFrame->argument(0).toWTFString(globalObject), "\n");
    return JSValue::encode(jsUndefined());
}

EncodedJSValue JSC_HOST_CALL globalFuncBuiltinDescribe(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsString(globalObject->vm(), toString(callFrame->argument(0))));
}

EncodedJSValue JSC_HOST_CALL globalFuncImportModule(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
...
EncodedJSValue JSC_HOST_CALL globalFuncPropertyIsEnumerable(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL globalFuncOwnKeys(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
#if ENABLE(INTL)
EncodedJSValue JSC_HOST_CALL globalFuncDateTimeFormat(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
