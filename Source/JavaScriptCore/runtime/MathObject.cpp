...
EncodedJSValue JSC_HOST_CALL mathProtoFuncACos(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncACosh(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncASin(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncASinh(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncATan(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncATanh(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncATan2(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncCbrt(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncCeil(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncClz32(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncCos(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncCosh(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncExp(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncExpm1(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncFround(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncHypot(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncLog(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncLog1p(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncLog10(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncLog2(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncMax(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncMin(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncPow(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncRandom(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncRound(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncSign(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncSin(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncSinh(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncSqrt(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncTan(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncTanh(HeapPtr<JSGlobalObject>, CallFrame*);
EncodedJSValue JSC_HOST_CALL mathProtoFuncIMul(HeapPtr<JSGlobalObject>, CallFrame*);
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncAbs(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsNumber(fabs(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncACos(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::acos(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncASin(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::asin(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncATan(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::atan(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncATan2(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncCeil(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsNumber(ceil(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncClz32(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncCos(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::cos(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncExp(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::exp(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncFloor(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsNumber(floor(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncHypot(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncLog(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::log(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncMax(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
    unsigned argsCount = callFrame->argumentCount();
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncMin(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
    unsigned argsCount = callFrame->argumentCount();
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncPow(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    // ECMA 15.8.2.1.13
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncRandom(HeapPtr<JSGlobalObject> globalObject, CallFrame*)
{
    return JSValue::encode(jsDoubleNumber(globalObject->weakRandomNumber()));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncRound(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsNumber(jsRound(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncSign(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    double arg = callFrame->argument(0).toNumber(globalObject);
    if (std::isnan(arg))
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncSin(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::sin(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncSqrt(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(sqrt(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncTan(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::tan(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncIMul(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    VM& vm = globalObject->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
...
EncodedJSValue JSC_HOST_CALL mathProtoFuncACosh(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::acosh(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncASinh(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::asinh(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncATanh(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::atanh(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncCbrt(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::cbrt(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncCosh(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::cosh(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncExpm1(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::expm1(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncFround(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(static_cast<float>(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncLog1p(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::log1p(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncLog10(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::log10(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncLog2(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::log2(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncSinh(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::sinh(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncTanh(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
    return JSValue::encode(jsDoubleNumber(Math::tanh(callFrame->argument(0).toNumber(globalObject))));
}

EncodedJSValue JSC_HOST_CALL mathProtoFuncTrunc(HeapPtr<JSGlobalObject> globalObject, CallFrame* callFrame)
{
